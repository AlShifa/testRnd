...
public class HelloSet2 {
	...
	public static void main(String[] args) {
		...
		//Without using Treeset 
		
		ArrayList aryList = new ArrayList(set);
		Collections.sort(aryList);
		//for(Emp emp : aryList)
		System.out.println("[ aryList ]"+aryList);
		
		MyComparator mycomp1 = new MyComparator();
		mycomp1.setSortType(1);
		Collections.sort(aryList,mycomp1);
		System.out.println("[comparator  aryList ]"+aryList);
		...
		hmap.put(5, new Emp(902, "uvw", 776));
